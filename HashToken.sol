...
contract HashToken is StandardToken {
    ...
    */
    string public name;                   //fancy name: eg The public name of token like ethers
    uint8 public decimals;                //How many decimals to show. ie. There could 1000 base units with 3 decimals. Meaning 0.980 SBX = 980 base units. It's like comparing 1 wei to 1 ether.
    string public symbol;                 //An identifier: eg ETH
    ...
    function HashToken(
        ...
        name = "Awsome Token";                        // ASM : Arun Kumar J / Senthil K / Muru G Tokem 
        decimals = 3;                                 // Amount of decimals for display purposes
        symbol = "ASM";                               // Set the symbol for display purposes
    }
